...
results2latex(sim.results.subset.AFT_LL,
              "Dependent covariates. Results AFT model. (1/2)",
              "tab: Dep cov. AFT. 1",
              nifpc.options = c(6, 8))
results2latex(sim.results.subset.AFT_LL,
              "Dependent covariates. Results AFT model. (2/2)",
              "tab: Dep cov. AFT. 2",
              nifpc.options = c(10, 15))
...
results2latex(sim.results.subset.Cox_wb,
              "Dependent covariates. Results Cox model. (1/2)",
              "tab: Dep cov. Cox. 1",
              nifpc.options = c(6, 8))
results2latex(sim.results.subset.Cox_wb,
              "Dependent covariates. Results Cox model. (2/2)",
              "tab: Dep cov. Cox. 2",
              nifpc.options = c(10, 15))
